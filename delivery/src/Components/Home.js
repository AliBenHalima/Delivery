...
useEffect(() => {
	...
	let GetAllProducts=()=>{
		axios.get("http://localhost:3000/Products/All", {
			 headers: {
			  "auth-token":"" //the token is a variable which holds the token
	  
		   }}).then((res)=>{console.log("allproducrs",res); 
		setelement({elements:res.data})
		})
        ...
        <li class="text-left">
				...
				<div className="container">
					<div className="row">
						<div className="col-md-12">
							<h1 className="m-b-20"><strong>Welcome To 
                                 Live Dinner Restaurant</strong></h1>
							<p className="m-b-40">See how your users experience your website in realtime or view    
							trends to see any changes in performance over time.</p>
							<p> <Link to="/Reservation"> <a className="btn btn-lg btn-circle btn-outline-new-white" >Reservation</a> </Link></p>
						</div>
					</div>
				</div>
			</li>
			<li className="text-left">
				...
				<div className="container">
					<div className="row">
						<div className="col-md-12">
							<h1 className="m-b-20"><strong>Welcome To   Live Dinner Restaurant</strong></h1>
							<p className="m-b-40">See how your users experience your website in realtime or view    
							trends to see any changes in performance over time.</p>
			...
			<li className="text-left">
				...
				<div className="container">
					<div className="row">
						<div className="col-md-12">
							<h1 className="m-b-20"><strong>Welcome To   Yamifood Restaurant</strong></h1>
							<p className="m-b-40">See how your users experience your website in realtime or view    
							trends to see any changes in performance over time.</p>
							<p><a className="btn btn-lg btn-circle btn-outline-new-white" href="#">Reservation</a></p>
						</div>
		...
		<div className="container">
			<div className="row">
				...
				<div className="col-lg-6 col-md-6 col-sm-12">
					<img src="assets/images/about-img.jpg" alt="" className="img-fluid" />
				</div>
			</div>
		</div>
	</div>
			...
			<div className="row inner-menu-box">
				...
				<div className="col-9">
					<div className="tab-content" id="v-pills-tabContent">
					  ...
					  {element.elements.map((value, index) => {
							return <Prod data={value}/>
					  })}
							...
							<div className="row">
								<div className="col-lg-4 col-md-6 special-grid drinks">
									<div className="gallery-single fix">
										<img src="assets/images/img-01.jpg" className="img-fluid" alt="Image" />
								...
								<div className="col-lg-4 col-md-6 special-grid drinks">
									<div className="gallery-single fix">
										<img src="assets/images/img-02.jpg" className="img-fluid" alt="image" />
										<div className="why-text">
								...
								<div className="col-lg-4 col-md-6 special-grid drinks">
									<div className="gallery-single fix">
										<img src="assets/images/img-03.jpg" className="img-fluid" alt="image" />
										<div className="why-text">
						...
						<div className="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
							<div className="row">
								<div className="col-lg-4 col-md-6 special-grid lunch">
									<div className="gallery-single fix">
										<img src="assets/images/img-04.jpg" className="img-fluid" alt="image" />
										<div className="why-text">
								...
								<div className="col-lg-4 col-md-6 special-grid lunch">
									<div className="gallery-single fix">
										<img src="assets/images/img-05.jpg" className="img-fluid" alt="image" />
										<div className="why-text">
								...
								<div className="col-lg-4 col-md-6 special-grid lunch">
									<div className="gallery-single fix">
										<img src="assets/images/img-06.jpg" className="img-fluid" alt="image" />
										<div className="why-text">
						...
						<div className="tab-pane fade" id="v-pills-settings" role="tabpanel" aria-labelledby="v-pills-settings-tab">
							<div className="row">
								<div className="col-lg-4 col-md-6 special-grid dinner">
									<div className="gallery-single fix">
										<img src="assets/images/img-07.jpg" className="img-fluid" alt="image" />
										<div className="why-text">
								...
								<div className="col-lg-4 col-md-6 special-grid dinner">
									<div className="gallery-single fix">
										<img src="assets/images/img-08.jpg" className="img-fluid" alt="image" />
										<div className="why-text">
								...
								<div className="col-lg-4 col-md-6 special-grid dinner">
									<div className="gallery-single fix">
										<img src="assets/images/img-09.jpg" className="img-fluid" alt="image" />
										<div className="why-text">
				...
				<div className="row">
					<div className="col-sm-12 col-md-4 col-lg-4">
						<a className="lightbox" href="images/gallery-img-01.jpg">
							<img className="img-fluid" src="assets/images/gallery-img-01.jpg" alt="Gallery Image" />
						</a>
					</div>
					<div className="col-sm-6 col-md-4 col-lg-4">
						<a className="lightbox" href="images/gallery-img-02.jpg">
							<img className="img-fluid" src="assets/images/gallery-img-02.jpg" alt="Gallery Image" />
						</a>
					</div>
					<div className="col-sm-6 col-md-4 col-lg-4">
						<a className="lightbox" href="images/gallery-img-03.jpg">
							<img className="img-fluid" src="assets/images/gallery-img-03.jpg" alt="Gallery Image" />
						</a>
					</div>
					<div className="col-sm-12 col-md-4 col-lg-4">
						<a className="lightbox" href="images/gallery-img-04.jpg">
							<img className="img-fluid" src="assets/images/gallery-img-04.jpg" alt="Gallery Image" />
						</a>
					</div>
					<div className="col-sm-6 col-md-4 col-lg-4">
						<a className="lightbox" href="images/gallery-img-05.jpg">
							<img className="img-fluid" src="assets/images/gallery-img-05.jpg" alt="Gallery Image" />
						</a>
					</div> 
					<div className="col-sm-6 col-md-4 col-lg-4">
						<a className="lightbox" href="images/gallery-img-06.jpg">
							<img className="img-fluid" src="assets/images/gallery-img-06.jpg" alt="Gallery Image" />
						</a>
					</div>
				</div>
			</div>
